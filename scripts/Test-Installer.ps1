...
$avifBuilder = Require-File 'scripts/Prepare-AvifTools.ps1'
...
Require-Text $builder 'Prepare-AvifTools\.ps1' 'Installer build must bundle the pinned AVIF tools.'
Require-Text $builder 'tools\\avif\\avifenc\.exe' 'Installer build must validate the bundled AVIF encoder.'
Require-Text $builder 'tools\\avif\\avifdec\.exe' 'Installer build must validate the bundled AVIF decoder.'
Require-Text $avifBuilder 'windows-artifacts\.zip' 'AVIF preparation must use the pinned official Windows artifact.'
Require-Text $avifBuilder 'Get-FileHash' 'AVIF preparation must verify downloaded and extracted files.'
...
Require-Text $releaseWorkflow 'BuildCache\\ocr\\python312-paddle330-paddleocr370-chardet520\\pip' 'Release workflow must cache pinned Python package downloads.'
Require-Text $releaseWorkflow 'BuildCache\\ocr\\python312-paddle330-paddleocr370-chardet520\\models' 'Release workflow must cache official OCR model downloads.'
Reject-Text $releaseWorkflow 'BuildCache\\ocr\\python312-paddle330-paddleocr370-chardet520\\bundled-runtime' 'Official releases must not restore an assembled OCR runtime cache.'
