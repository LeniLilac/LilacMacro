...
**Effective August 15, 2026. Updated August 16, 2026.**

LilacMacro is a free, noncommercial, source-available Windows utility licensed under the PolyForm Noncommercial License 1.0.0. By installing or using LilacMacro or its hosted services, you agree to these terms and the [Privacy Notice](PRIVACY.md). If you do not agree, do not install or use the software or services.
...
Official installers are hosted only on this repository's GitHub Releases page. They are intentionally not Authenticode-signed, so Windows may identify the publisher as unknown. Releases include a SHA-256 checksum and an Ed25519 project-signed manifest. That signature proves continuity with the public LilacMacro release key; it is not a legal-identity certificate or a guarantee that the software is error-free.
...
Material privacy-choice changes require a new in-app notice version. For questions, legal notices, or private security reports, email [lilithlilac000@gmail.com](mailto:lilithlilac000@gmail.com). Do not put secrets, private links, or diagnostic captures in a public issue. These terms describe project policy and are not a substitute for qualified legal advice.
