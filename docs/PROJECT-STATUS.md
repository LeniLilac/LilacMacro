...
| Appearance themes | Prototype | Settings applies and atomically persists a Light/Dark mode plus a visual two-row palette grid containing ten paired solid families and ten gradient families with unique Light and Dark definitions; semantic status and game-state colors remain stable |
